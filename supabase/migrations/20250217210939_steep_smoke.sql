/*
  # Fix Tithe and Offering Management Schema

  1. Drop and Recreate Tables
    - Safely drops existing tables if they exist
    - Recreates tables with proper structure
    - Maintains all functionality

  2. Features
    - Double verification system for offerings
    - Default categories
    - Status tracking
  ...
  3. Security
    ...
    - Admin and finance role-based access
    - Verification limits enforced
*/

-- Drop existing tables if they exist
DROP TABLE IF EXISTS tithe_offering_verifications;
DROP TABLE IF EXISTS tithe_offerings;
DROP TABLE IF EXISTS tithe_offering_categories;
...
-- Insert default categories without requiring created_by
