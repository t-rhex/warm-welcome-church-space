import { ChevronDown, Clock, MapPin, Heart, BookOpen, AlertCircle, BookOpenCheck, Bookmark } from "lucide-react";
    ...
    return (
      <Card className="col-span-3">
        <CardContent className="p-8 text-center">
          ...
          <h3 className="text-xl font-display text-church-800 mb-2">No Announcements</h3>
      ...
      {announcements.map((announcement) => (
        <Card key={announcement.id} className="bg-white">
          <CardContent className="p-6">
            ...
            <h3 className="text-xl font-display text-church-800 mb-3">{announcement.title}</h3>
            <p className="text-church-600 mb-4 text-sm">{announcement.content}</p>
            {announcement.link && (
              <Button 
                variant="link" 
    ...
    return (
      <div className="relative">
        <div className="flex gap-6 overflow-x-auto pb-6 snap-x">
          {[1, 2, 3].map((index) => (
            <div key={index} className="min-w-[300px] md:min-w-[400px] snap-start animate-pulse">
          ...
          <div key={event.id} className="min-w-[300px] md:min-w-[400px] snap-start">
            <Card className="h-full">
              <CardContent className="p-6">
                ...
                <div className="space-y-2">
                  <h3 className="text-xl font-display text-church-800">{event.title}</h3>
                  <p className="text-church-600">{event.short_description || event.description}</p>
      ...
      <section className="py-24 bg-gradient-to-b from-white to-church-50">
        <div className="container max-w-4xl mx-auto px-4">
          ...
          <div className="mb-12 text-center">
            <h3 className="text-2xl font-display text-church-800 mb-4">Join Us in Prayer</h3>
      ...
      <section className="py-20 bg-church-50">
        <div className="container max-w-6xl mx-auto px-4">
          <div className="text-center mb-16">
            <span className="text-church-500 font-body uppercase tracking-wider text-sm">Latest Updates</span>
            <h2 className="mt-4 text-4xl font-display text-church-900">Church Announcements</h2>
          </div>
          <Announcements />
      ...
      <section className="py-20 bg-white overflow-hidden">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12 space-y-4">
            <div>
              <span className="text-church-500 font-body uppercase tracking-wider text-sm">Mark Your Calendar</span>
              <h2 className="mt-4 text-4xl font-display text-church-900">Featured Events</h2>
            </div>
            <Button 
              variant="outline" 
              className="border-church-600 text-church-600 hover:bg-church-600 hover:text-white"
